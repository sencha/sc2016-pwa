...
Ext.define('Ext.exporter.file.ooxml.Excel', {
    ...
    destroy: function() {
        var me = this,
            workbook, properties, relationships;
        workbook = me.getWorkbook();
        properties = me.getProperties();
        relationships = me.getRelationships();
        me.setWorkbook(null);
        me.setProperties(null);
        me.setRelationships(null);
        Ext.destroy(workbook, properties, relationships);
        me.callParent();
    },
    render: function() {
        var files = {},
...
Ext.define('Ext.exporter.Plugin', {
    ...
    saveDocumentAs: function(config) {
        ...
        Ext.asap(this.delayedSave, this, [
            exporter,
            config,
            deferred
        ]);
